...
//almost exactly answerscript and answerscript2 but cannot extend each other/compile into 1
//because otherwise the objects will all do the same things at the same time
{
    ...
    private static Answer1Script instance; //the instance of the object w this script
     ...
     **/
    public static Answer1Script Instance
    {
        get
        {
            if (instance == null)
            {
                instance = GameObject.FindObjectOfType<Answer1Script>();
            }
            return instance;
        }
