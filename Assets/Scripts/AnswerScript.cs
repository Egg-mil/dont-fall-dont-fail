...
//almost exactly answerscript1 and answerscript2 but cannot extend each other/compile into 1
//because otherwise the objects will all do the same things at the same time
{
    ...
    private static AnswerScript instance; //the instance of the object w this script
   ...
   **/
    ...
    /**
     *   sets instance equal to the game object that uses AnswerScript
     **/
    public static AnswerScript Instance
    {
        get
        {
            if (instance == null)
            {
                instance = GameObject.FindObjectOfType<AnswerScript>();
            }
            return instance;
        }
